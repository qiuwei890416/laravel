    ...
    <div id="footer-nav" class="layout-wrap">
        <div id="footer-nav-left">
            ...
            <div id="footer-copyright">
                &copy; 2013 - 2016
                <a target="_blank" rel="nofollow" href="http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=53230102000151" style="display:inline-block;text-decoration:none;height:20px;line-height:20px;"><img src="{{ URL::asset('Home1/images/beiantubiao.png') }}" style="float:left;" />滇公网安备 53230102000151号</a>&nbsp;|&nbsp;Theme by&nbsp;
                <a href="http://www.zhiyanblog.com/tinection.html" target="_blank">Tinection</a> <a href="http://www.sucainiu.com/templates">网页模板免费下载</a>. &nbsp;|&nbsp; &nbsp;|&nbsp;
                <a href="http://www.miitbeian.gov.cn/" target="_blank">滇ICP备********号-1</a>
