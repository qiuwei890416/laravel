<script type="text/javascript" src="{{ URL::asset('Home1/js/zh-cn-tw.js') }}"></script>
<script type="text/javascript" src="{{ URL::asset('Home1/js/comments-ajax.js') }}"></script>
<script type="text/javascript" src="{{ URL::asset('Home1/js/ajax-sign-script.min.js') }}"></script>
<script type="text/javascript" src="{{ URL::asset('Home1/js/prettify.js') }}"></script>
...
<script type="text/javascript" src="{{ URL::asset('Home1/js/theme.js?ver=4.3.6') }}"></script>
<!-- /.Footer -->
<script type="text/javascript">
