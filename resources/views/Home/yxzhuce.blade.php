...
<div style="width: 500px;height: 400px;margin: auto;background: #afafaf">
    <form action="{{ url('/doyxzhuce') }}" method="post">
    {{csrf_field()}}
    <h3 style="text-align: center;font-size: 30px;margin-bottom: 50px;padding-top: 30px;">邮箱注册</h3>
    ...
    <p style="margin-left: 35%;">
        <span style="margin-right: 20px;"><button type="submit" style="background: #0b8fba;width: 50px;height: 40px;font-size: 20px;color:white; ">注册</button></span>
