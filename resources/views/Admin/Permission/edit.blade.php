...
{{--                    </div>--}}
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="L_username" name="per_name" value="{{$data->per_name}}" required="" lay-verify="nikename" autocomplete="off" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label for="L_username" class="layui-form-label">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="L_username" name="pre_url" value="{{$data->pre_url}}" required="" lay-verify="nikename" autocomplete="off" class="layui-input">
                        </div>
                    </div>
        ...
        <script>layui.use(['form', 'layer'],
            function() {
                ...
                function(data) {
                    ...
                    //发异步，把数据提交给php
                    $.ajax({
                        url:'/admin/Permission/'+data.field.id,
                        type:'PUT',
                        timeout:"3000",
                        dataType : 'json',
                        cache:"false",
