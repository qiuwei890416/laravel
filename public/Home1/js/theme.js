...
$('.collect').click(function(){
	var _this = $(this);
	var pid = Number(_this.attr('data-id'));

	if(_this.attr('data-uid')&&_this.hasClass('collect-no')){
		var uid = Number(_this.attr('data-uid'));
		$.ajax({
			type: 'POST',
			dataType: 'html',
			url: 'shoucang',
		...
		return false;
	}else if(_this.attr('data-uid')&&_this.hasClass('collect-yes')){
		var uid = Number(_this.attr('data-uid'));
		$.ajax({
			type: 'POST',
			dataType: 'html',
